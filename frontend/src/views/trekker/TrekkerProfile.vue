        ...
        <div class="row">
            <div class="fs-5  mb-3 text-center">
                ...
                <div class="d-flex justify-content-center">
                    <RouterLink :to="{name: 'trekker-edit-profile'}" class="btn btn-primary">Edit Profile</RouterLink>
                    <RouterLink :to="{name: 'trekker-edit-password'}" class="btn btn-secondary ms-2">Change Password</RouterLink>
                </div>
            </div>
        </div>  
    </div>
