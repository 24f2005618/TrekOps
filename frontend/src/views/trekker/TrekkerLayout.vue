...
<template>
  <div v-if="$store.getters.getRoles.includes('trekker')">
      ...
      >
        ...
        <div class="p-0 d-flex flex-column flex-grow-1">
          <nav class="nav nav-pills flex-column gap-1 p-3">
            <RouterLink :to="{name:'trekker-dashboard'}" class="nav-link text-white" active-class="active">
              Dashboard
            </RouterLink>

            <RouterLink :to="{name:'trekker-browse-treks'}" class="nav-link text-white" active-class="active">
              Browse Treks
            </RouterLink>

            <RouterLink :to="{name:'trekker-my-bookings'}" class="nav-link text-white" active-class="active">
              My Bookings
            </RouterLink>

            <RouterLink :to="{name:'trekker-history'}" class="nav-link text-white" active-class="active">
              History
            </RouterLink>

            <RouterLink :to="{name:'trekker-profile'}" class="nav-link text-white" active-class="active">
              Profile
            </RouterLink>
  ...
  <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end text-center">
    <li><a class="dropdown-item" href="/trekker/edit/profile">Edit</a></li>
